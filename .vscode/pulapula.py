class Kid: # criação da class Criança
...
class Trampoline: # criação do trampoline
    def __init__(self):
        self.playing: list[Kid] = [] # lista do pula pula
        self.waiting: list[Kid] = [] # lista de espera pra entrar no pula pula
